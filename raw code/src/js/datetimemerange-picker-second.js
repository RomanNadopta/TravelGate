      ...
      function handleTabletChange(e) {
        if (e.matches) {
          ...
          if (
            ...
            travelSelectDateOpened.style.height = "380px";
          }
        }
      }

      let mediaQueryDesktop = window.matchMedia("(min-width: 1110px)");
    ...
    hide: function (e) {
      ...
      if (this.container.style.display == "none") {
        ...
        if (travelSelect.classList.contains("travel-select__date--opened")) {
          travelSelectDateOpened.style.height = "140px";
        }
        let leftArrow = document.querySelector(".arrow-left__date");
        leftArrow.addEventListener("click", function () {
          travelSelectDateOpened.style.height = "auto";
        });
      }
    },
